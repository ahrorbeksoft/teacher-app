...
const buttonVariants = cva(
  "inline-flex items-center gap-2 justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          "bg-destructive text-primary-foreground shadow-sm hover:bg-destructive/90 transition-all",
        outline:
          "border border-input bg-background shadow-sm hover:bg-secondary hover:text-secondary-foreground transition-all",
        warning:
          "border-transparent bg-yellow-500 text-yellow-900 hover:bg-yellow-400 dark:bg-yellow-400 dark:text-yellow-900 dark:hover:bg-yellow-400 dark:hover:text-yellow-900",
    ...
    return tooltipText ? (
      <TooltipProvider>
        <Tooltip>
          ...
          {/* ["warning", "secondary", "outline", "desctructive" ] */}
          <TooltipContent
            variant={
              variant === "default"
                ? "default"
